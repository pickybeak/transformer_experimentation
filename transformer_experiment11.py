...
def program_loop():
    ...
    class PositionAttentionLayer(pl.LightningModule):
        ...
        def forward(self, x, query_len):
            ...
            overall = self.overall_transform(x)
            # overall : [batch_size, query_len, d_p]
            abs_pos = self.abs_pos_embedding(overall_map)

            local_weight = self.local_weight(overall)
            # local_weight : [batch_size, query_len, 1]
